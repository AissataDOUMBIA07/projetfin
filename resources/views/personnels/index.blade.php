...
@if(count($errors) > 0)
  ...
  @endif
    ...
    <!-- bouton d'ajout -->
    <div class="col-md-5">
        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modalperson">
    ...
    <div class="card-body" style="width: 80%; margin: auto;">
        <table id="datatable" class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row" class="masque">{{$perso->id}}</td>
                    <th scope="row">{{$perso->nom}}</td>
                    <th scope="row">{{$perso->prenom}}</td>
                    <th scope="row">{{$perso->fonction}}</td>
                    <th scope="row">{{$perso->telephone}}</td>
                    <td>
